  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        git-branch-harjoitus = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              git-branch-harjoitus = final.callPackage git-branch-harjoitus { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.git-branch-harjoitus;
        devShells = {
          ...
          default = pkgs.mkShell {
            inputsFrom = [ pkgs.git-branch-harjoitus ];
          };
