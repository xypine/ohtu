  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        poetry-web = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              poetry-web = final.callPackage poetry-web { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.poetry-web;
        devShells = {
