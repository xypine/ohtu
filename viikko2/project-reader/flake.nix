  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        project-reader = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              project-reader = final.callPackage project-reader { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.project-reader;
        devShells = {
          ...
          default = pkgs.mkShell {
            inputsFrom = [ pkgs.project-reader ];
          };
