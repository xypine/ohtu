  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        verkkokauppa = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              verkkokauppa = final.callPackage verkkokauppa { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.verkkokauppa;
        devShells = {
